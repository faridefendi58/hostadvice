...
!function (a) {
    ...
    }, messages: {required: tr("This field is required."), remote: tr("Please fix this field."), email: tr("Please enter a valid email address."), url: tr("Please enter a valid URL."), date: tr("Please enter a valid date."), dateISO: tr("Please enter a valid date ( ISO )."), number: tr("Please enter a valid number."), digits: tr("Please enter only digits."), creditcard: tr("Please enter a valid credit card number."), equalTo: tr("Please enter the same value again."), maxlength: a.validator.format(tr("Please enter no more than {0} characters.")), minlength: a.validator.format(tr("Please enter at least {0} characters.")), rangelength: a.validator.format(tr("Please enter a value between {0} and {1} characters long.")), range: a.validator.format(tr("Please enter a value between {0} and {1}.")), max: a.validator.format(tr("Please enter a value less than or equal to {0}.")), min: a.validator.format("Please enter a value greater than or equal to {0}.")}, autoCreateRanges: !1, prototype: {init: function () {
        function b(b) {
