...
class HostingPromocodeModel extends \Model\BaseModel
{
    ...
    public function getData($data = null)
    {
        $sql = 'SELECT t.*, a.name AS admin_name, 
            c.title AS hosting_company_name    
            FROM {tablePrefix}ext_hosting_promocode t 
